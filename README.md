...
[![Pub Version](https://img.shields.io/badge/pub-v1.3.1-green)](https://pub.dev/packages/thermal_printer_plus)
...
thermal_printer_plus is compatible only from version 21 of Android SDK so you should change this in android/app/build.gradle:
...
```
   <receiver
        android:name="com.safvanp.thermal_printer_plus.usb.UsbReceiver"
