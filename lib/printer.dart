...
final flutterPrinterChannel =
    const MethodChannel('com.safvanp.thermal_printer_plus');
final flutterPrinterEventChannelBT =
    const EventChannel('com.safvanp.thermal_printer_plus/bt_state');
final flutterPrinterEventChannelUSB =
    const EventChannel('com.safvanp.thermal_printer_plus/usb_state');
final iosChannel = const MethodChannel('thermal_printer_plus/methods');
final iosStateChannel = const EventChannel('thermal_printer_plus/state');
